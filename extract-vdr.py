...
vdrFile = 'VDR/24082023VDR AA3.xlsx'
fileTemplate = 'Template.xlsx'
file = "AISHAH AIMS 3.xlsx"
...
wb = load_workbook(vdrFile, data_only=True)
sheet = wb['VDR']

date_date = date.today()
todayDate = date_date.strftime("%d/%m/%Y")
shipMMSI = 533180042
...
for row in sheet.iter_rows(min_row=14,max_row=103,min_col=23,max_col=35):
